...
import { User, Mail, Lock, Bell, Moon, Sun, Shield, Camera, Save, Globe } from 'lucide-react';
        ...
        <div className="space-y-8">
          <div className="glass p-8 rounded-3xl text-center space-y-6">
            ...
            <div>
              ...
              <p className="text-white/40 text-sm">alex.johnson@example.com</p>
            </div>
            <div className="pt-4 flex justify-center gap-4">
              <div className="text-center">
                <p className="text-xl font-bold text-gold">12</p>
                <p className="text-[10px] text-white/40 uppercase font-bold">Streak</p>
              </div>
              <div className="w-px h-8 bg-white/10"></div>
              <div className="text-center">
                <p className="text-xl font-bold text-edu-blue">142</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input type="text" defaultValue="Alex Johnson" className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-12 pr-4 focus:border-gold/50 outline-none transition-all" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input type="email" defaultValue="alex.johnson@example.com" className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-12 pr-4 focus:border-gold/50 outline-none transition-all" />
                </div>
              </div>
              <div className="space-y-2 md:col-span-2">
                <label className="text-xs font-bold text-white/40 uppercase tracking-widest">Bio</label>
                <textarea 
                  defaultValue="Computer Science student passionate about AI and machine learning. Always looking for new ways to optimize my study routine."
                  className="w-full bg-white/5 border border-white/10 rounded-xl p-4 min-h-[100px] focus:border-gold/50 outline-none transition-all resize-none"
                />
              </div>
            </div>
          </div>
